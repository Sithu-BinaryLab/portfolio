...
export const FullResumeComponent = () => {
  ...
  return (
    <div className="py-10">
      ...
      >
          ...
          <span className="inline-block">
            ...
            >
              ...
              <g>
                <path
                  style={{ fill: "#F6C358" }}
                  d="M157.6,124.931l0.043,0.028l0,0v-0.038l0.019,0.026l0.023-0.015v-0.001l0.008-0.01v0.005
		...
		c-4.228,0.112-10.251-4.22-12.82-6.237c-0.653-0.514-1.324-1.004-2.013-1.469v17.511l0.001-0.001L157.6,124.931z"
                ...
                <polygon
                  style={{ fill: "#F6C358" }}
                  points="157.642,118.613 157.643,118.614 157.643,118.612 157.643,118.612 152.431,125.71 
		152.431,125.71 	"
                />
              </g>
              <path
                style={{ fill: "#64798A" }}
                d="M184.576,77.31c0,0,0.931-6.289,4.152-11.454c0.782-1.254,1.21-2.696,1.21-4.174V45.427
	...
	c0,2.587,0.866,5.105,2.486,7.123c1.275,1.587,2.599,4.083,2.803,7.695"
              ...
              <path
                style={{ fill: "#FCD462" }}
                d="M156.316,107.742c0,0,6.932,1.095,14-5.295c1.098-0.992,2.267-1.901,3.486-2.74
	...
	c0.688,0.465,1.359,0.955,2.013,1.469C146.064,103.522,152.088,107.854,156.316,107.742z"
              ...
              <g>
                <polygon
                  style={{ fill: "#D5D6DB" }}
                  points="162.854,124.331 159.555,129.068 162.602,148.269 170.237,134.387 	"
                />
                <polygon
                  style={{ fill: "#D5D6DB" }}
                  points="152.936,149.451 156.276,128.402 152.644,123.186 144.552,134.206 	"
                />
                <polygon
                  style={{ fill: "#D5D6DB" }}
              ...
              <g>
                <polygon
                  style={{ fill: "#E56353" }}
                  points="162.946,146.473 160.357,130.154 163.16,126.128 163.16,126.128 157.643,118.612 
		...
		152.378,146.545 157.643,156.117 162.946,146.475 	"
                ...
                <polygon
                  style={{ fill: "#E56353" }}
                  points="157.675,156.176 158.177,155.672 157.659,156.147 	"
                />
                <polygon
                  style={{ fill: "#E56353" }}
                  points="157.626,156.147 157.108,155.672 157.611,156.176 	"
                />
                <polygon
                  style={{ fill: "#E56353" }}
                  points="157.619,156.184 157.643,156.208 157.666,156.184 157.643,156.162 157.643,156.162 
		157.642,156.162 	"
                />
                <polygon
                  style={{ fill: "#E56353" }}
                  points="157.693,118.572 157.685,118.582 157.693,118.578 	"
                />
                <polygon
                  style={{ fill: "#E56353" }}
                  points="157.643,118.572 157.643,118.611 157.662,118.598 	"
                />
              </g>
              <g>
                <polygon
                  style={{ fill: "#E1E6E9" }}
                  points="157.693,118.578 157.685,118.582 157.685,118.583 157.662,118.598 157.643,118.611 
		...
		173.802,107.814 173.801,107.814 	"
                ...
                <polygon
                  style={{ fill: "#E1E6E9" }}
                  points="152.15,126.092 152.151,126.091 152.431,125.71 157.643,118.612 157.643,118.612 
		157.643,118.611 157.6,118.583 141.484,107.814 141.484,107.814 132.789,110.931 145.849,134.675 	"
              ...
              <g>
                <path
                  style={{ fill: "#3A556A" }}
                  d="M157.675,156.176l0.018,0.032h6.797h51.92c3.717,0,6.545-3.335,5.938-7.002l-2.925-17.663
		c-0.789-4.764-4.089-8.731-8.63-10.374l-28.297-10.238"
                />
                <polygon
                  style={{ fill: "#3A556A" }}
                  points="157.666,156.184 157.643,156.208 157.643,156.208 157.693,156.208 	"
                />
              </g>
              <g>
                <polygon
                  style={{ fill: "#2F4859" }}
                  points="162.946,146.475 157.643,156.117 157.643,156.117 157.659,156.147 158.177,155.672 
		183.8,132.234 180.612,126.147 190.012,126.002 182.496,110.931 169.437,134.675 	"
              ...
              <path
                style={{ fill: "#3A556A" }}
                d="M157.619,156.183l-0.008-0.007l-24.822-45.245l-28.297,10.238c-4.541,1.643-7.841,5.609-8.63,10.373
	l-2.925,17.665c-0.607,3.666,2.222,7.001,5.939,7.001h51.97h4.013h0.05h2.734h0.001L157.619,156.183z"
              />
              <polygon
                style={{ fill: "#2F4859" }}
                points="157.675,156.176 157.659,156.147 157.643,156.117 157.643,156.117 152.378,146.545 
